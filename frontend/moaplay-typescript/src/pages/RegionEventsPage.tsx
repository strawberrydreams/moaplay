...
import * as S from '../styles/pages/RegionEventsPage.styles';
import { FaChevronLeft, FaChevronRight } from 'react-icons/fa';
import { EventGrid, NoResultsMessage } from '../styles/components/EventSearch.styles';
...
const RegionEventsPage: React.FC = () => {
