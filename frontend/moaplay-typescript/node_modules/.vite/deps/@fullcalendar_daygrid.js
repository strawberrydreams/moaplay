...
function computeFgSegPlacement(segs, dayMaxEvents, dayMaxEventRows, strictOrder, segHeights, maxContentHeight, cells) {
	...
	for (let i = 0; i < segs.length; i += 1) {
		...
		if (segHeights[segUid] != null) segInputs.push({
			index: i,
			span: {
				start: seg.firstCol,
				end: seg.lastCol + 1
